	...
	if (!empty($_POST["startupname"])) 
        {	  
           ...
           $query2 = "SELECT startup_id FROM stpinext_start_up_details where startup_id = ".$last_id ." and login_id = $login_id;";
			...
			//echo $appid; die;
			$fileurl = 'http://stpinext.in/wp-content/';
			$filepath_url_ext = $fileurl.$path_filename_ext;
			$filepath_url_ext2 = $fileurl.$path_filename_ext2;
			...
			'$competitors', '$diffrence', '$usp', '$area_sector', '$filename2', '$filepath_url_ext2')";
			//echo $idea; die;
		...
		<div class="col-md-10">
			<form id="msform" action="" method="POST" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<div class="">
						<input type="text" name="startupname" id="startupname" placeholder="Name of start-up" class="myreq" maxlength="100" onblur="return Validate()"/>
						<label class="message" id="message" style="color:#ff0000;font-weight:bold;">
					</div>
					<div class="">
						<input type="text" name="cin" id="cin" placeholder="CIN No." maxlength="100" class="myreq" onblur="return Validate()"/>
						<label class="message" id="message2" style="color:#ff0000;font-weight:bold;">
					</div>
					<div class="">
					<p>DPIIT Registered?</p>
								<select class="myreq" name="dpiit" id="dpiit" onblur="return Validate()"> 
					...
					<div>
						<input type="text" class="myreq" name="city" id="city" placeholder="City" maxlength="100" onblur="return Validate2()"/>
					...
					<div>
						<input type="text" class="myreq" name="country" id="country" placeholder="Country" maxlength="100"  onblur="return Validate2()"/>
						<label class="message" id="message5" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>			
						<input type="text" class="myreq" name="pin" id="pin" placeholder="PIN" maxlength="6"  onblur="return Validate2()"/>
					...
					<div>
						<input type="text" class="myreq" name="person" id="person" placeholder="Contact Person Name" maxlength="100" onblur="return Validate3()"/>
						<label class="message" id="message7" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<input type="text" class="myreq" name="persondesignation" id="persondesignation" placeholder="Designation" maxlength="100" onblur="return Validate3()"/>
						<label class="message" id="message8" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<input type="text" class="myreq" name="mobile" id="mobile" placeholder="Mobile" maxlength="10" onblur="return Validate3()"/>
						<label class="message" id="message9" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<input type="email" class="myreq" name="email" id="email" placeholder="Email" maxlength="100" onblur="return Validate3()" onkeyup="ValidateEmail();" />
						<span id="lblError" style="color: red"></span><br>
						<label class="message" id="message10" style="color:#ff0000;font-weight:bold;">
					</div>
					</section>
					<hr>
					<input type="button" name="next" disabled="true" id="send" class="next action-button" value="Next" style="background-color:C5C5F1;"/>
				</fieldset>
				<fieldset>
					...
					<section align="left">
					<div>
						<input type="text" name="teamsize" id="teamsize" placeholder="No. of founders/promoters" maxlength="2" onblur="return Validate4()" class="myreq2"/>
						<label class="message" id="message11" style="color:#ff0000;font-weight:bold;">
					</div>	
					<div>
						<input type="text" name="name" id="name" placeholder="Name of the first founder/promoter" maxlength="100" onblur="return Validate4()" class="myreq2"/>
						<label class="message" id="message12" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<input type="text" name="designation" id="designation" placeholder="Current designation held in the entity" maxlength="100" onblur="return Validate4()" class="myreq2"/>
						<label class="message" id="message13" style="color:#ff0000;font-weight:bold;">
					</div>	
					<div>
						<input type="text" name="experience" id="experience" placeholder="Experience in brief" maxlength="100" onblur="return Validate4()" class="myreq2"/>
					...
					<input type="file" onchange="fileValidation();" id="othersfounders" name="othersfounders" placeholder="Other founders details"/>
					<span id="fileerror" style="color:#ff0000;font-weight:bold;"></span>
					<span id="filecorrect" style="color:#0d7500; font-weight:bold;"></span>
					</section>
					<hr>
					<input type="button" name="previous" class="previous action-button-previous" value="Previous"/>
					<input type="button" name="next" disabled="true" id="send2" class="next action-button" value="Next" style="background-color:C5C5F1;"/>
				</fieldset>
				<fieldset>
					...
					<section align="left">
					<div>
						<textarea type="text" name="idea" id="idea" placeholder="Briefly describe your idea" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message15" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="problem" id="problem" placeholder="What problem are you solving?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea>
						<label class="message" id="message16" style="color:#ff0000;font-weight:bold;">
					</div>
					<div> 
						<textarea type="text" name="solution" id="solution" placeholder="What is your solution?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message17" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="customer" id="customer" placeholder="Who will be your customer?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message18" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="ptential" id="potential" placeholder="What is your market potential?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message19" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="competitors" id="competitors" placeholder="Do you have any competitors?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message20" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="diffrence" id="diffrence" placeholder="How are you different from your competitor?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message21" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="usp" id="usp" placeholder="What is your USP ( Unique Selling Proposition)?" maxlength="100" onblur="return Validate5()" class="myreq3"></textarea> 
						...
						<div class="container col-md-12">
							<div class="col-md-3" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Big Data" name="sectors[]" class="areaCheck">Big Data<span class="checkmark"></span>
								</label>
							</div> 
							<div class="col-md-4" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox"  class="areaCheck" value="Internet Of Things" name="sectors[]">Internet Of Things<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-5" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Artificial Intelligence (AI)" name="sectors[]" class="areaCheck">Artificial Intelligence<span class="checkmark"></span>
								</label>
							</div>
						</div>  
						<div class="container col-md-12"> 
							<div class="col-md-3" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Robotics" name="sectors[]" class="areaCheck">Robotics<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-4" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Smart Sensors" name="sectors[]" class="areaCheck">Smart Sensors<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-5" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Virtual/Augmented reality" name="sectors[]" class="areaCheck">Virtual/Augmented reality<span class="checkmark"></span>
								</label>
							</div>
						</div> 
						<div class="container col-md-12"> 
							<div class="col-md-3" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Photonics" name="sectors[]"  class="areaCheck">Photonics<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-4" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Block Chain" name="sectors[]" class="areaCheck">Block Chain<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-5" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Additive Manufacturing" name="sectors[]">Additive Manufacturing<span class="checkmark" class="areaCheck"></span>
								</label>
							</div>
						</div> 
						<div class="container col-md-12"> 
							<div class="col-md-3" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="GIS" name="sectors[]">GIS<span class="checkmark" class="areaCheck"></span>
								</label>
							</div>
							<div class="col-md-4" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Fintech" name="sectors[]" class="areaCheck">Fintech<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-md-5" align="left">
								<label class="checkbox-inline" style="padding-left:33px;">
								  <input type="checkbox" value="Machine Learning" name="sectors[]" class="areaCheck">Machine Learning<span class="checkmark"></span>
								</label>
							</div>
						</div> 
					...
					<input type="file"  name="businessproposal" id="businessproposal" placeholder="Detailed Business Proposal" onchange="fileValidation2();"/>
					<span id="fileerror2" style="color:#ff0000;font-weight:bold;"></span>
					<span id="filecorrect2" style="color:#0d7500; font-weight:bold;"></span>
					</section>
					<hr>
					<input type="button" name="previous" class="previous action-button-previous" value="Previous"/>
					<input type="button" disabled="true" name="next" class="next action-button" value="Next" id="send3" style="background-color:C5C5F1;"/>
				</fieldset>
				<fieldset>
					...
					--> 
								...
								<label class="container">Agartala
								  <input type="checkbox" value="Agartala" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Bhilai
								  <input type="checkbox" value="Bhilai" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Bhopal
								  <input type="checkbox" value="Bhopal" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Bhubaneswar
								  <input type="checkbox" value="Bhubaneswar" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Dehradun
								  <input type="checkbox" value="Dehradun" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Guwahati
								  <input type="checkbox" value="Guwahati" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>

								<label class="container">Jaipur
								  <input type="checkbox" value="Jaipur" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label> 
								<label class="container">Lucknow(with an extension centre at Prayagraj)
								  <input type="checkbox" value="Lucknow" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>
								<label class="container">Mohali/Panchkula
								  <input type="checkbox" value="Mohali/Panchkula" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label> 

								<label class="container">Patna
								  <input type="checkbox" value="Patna" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label>


								<label class="container">Vijayawada
								  <input type="checkbox" value="Vijayawada" class="myreq4 myreq44" name="location[]">
								  <span class="checkmark"></span>
								</label> 
								<p>&nbsp;</p>
								<h4>Services</h4>
								...
								<label for="workspace" class="container">
										Workspace
									<input type="checkbox" id="workspace" class="myreq4 myreq5"/>
								  <span class="checkmark"></span> 
								</label> 
								...
								<label for="spst" class="container">
									...
									<input type="checkbox" id="spst" name="spst" value="Yes" class="myreq4 myreq5" />
								  <span class="checkmark"></span> 
								</label>  
								
								<label for="funding" class="container">
										Seed Funding
									<input type="checkbox" id="funding" value="Yes" name="funding" class="myreq4 myreq5" />
								  <span class="checkmark"></span> 
								</label>  
								  ...
								  <span class="checkmark"></span> 
									...
									<div id="dvmentoring" style="display: none; padding:20px;"> 
										<label for="startupbootcamps" class="container">
											Startup boot camps
											<input type="checkbox" id="startupbootcamps" name="mentoring[]" value="Startup boot camps" class="myreq4 myreq5"/>
											<span class="checkmark"></span> 
										</label> 
										<label for="businessmentoring" class="container">
											Business Mentoring
											<input type="checkbox" id="businessmentoring" name="mentoring[]" value="Business Mentoring" class="myreq4 myreq5"/>
											<span class="checkmark"></span> 
										</label> 
										<label for="technicalmentoring" class="container">
											Technical Mentoring
											<input type="checkbox" id="technicalmentoring" name="mentoring[]" value="Technical Mentoring" class="myreq4 myreq5"/>
											<span class="checkmark"></span> 
										</label> 
									</div> 
								...
								<label for="marketing" class="container">
										Marketing
									<input type="checkbox" id="marketing" name="marketing" value="Yes" class="myreq4 myreq5"/>
								  <span class="checkmark"></span> 
								</label>  
								
								<label for="patenting" class="container">
										Patenting/IPR Consulting
									<input type="checkbox" id="patenting" name="patenting" value="Yes" class="myreq4 myreq5"/>
								  <span class="checkmark"></span> 
								</label>  
								...
								<div id="dvregistration" style="display: none; padding:20px;"> 
									<label for="registration" class="container">
										...
										<input type="checkbox" id="registration" value="Registration/Incorporation Consulting" name="support[]" class="myreq4 myreq5"/>
									  <span class="checkmark"></span> 
									</label> 
									<label for="legal" class="container">
											Legal Consulting
										<input type="checkbox" id="legal" value="Legal Consulting" name="support[]" class="myreq4 myreq5"/>
									  <span class="checkmark"></span> 
									</label> 
									<label for="hrconsulting" class="container">
											HR Consulting
										<input type="checkbox" id="hrconsulting" value="HR Consulting" name="support[]"class="myreq4 myreq5"/>
									  <span class="checkmark"></span> 
									</label> 
									<label for="finance" class="container">
											Finance/Tax Consulting
										<input type="checkbox" id="finance" value="Finance/Tax Consulting" name="support[]" class="myreq4 myreq5"/>
									  <span class="checkmark"></span> 
									</label> 
								</div>    
								<label for="anyother" class="container">
										Any other
									<input type="checkbox" id="anyother"  class="myreq4 myreq5"/>
								  <span class="checkmark"></span> 
								</label> 
					...
					<hr>
					<input type="button" name="previous" class="previous action-button-previous" value="Previous"/>
					<input type="submit" name="submit" id="send4"  disabled="true"  style="background-color:C5C5F1;" class="action-button" value="Submit"/>
				</fieldset>
			</form> 
		</div>
		<div class="col-md-1">&nbsp;</div>
...
$(document).ready(function(){
	$('.myreq').keyup(function(){
		if($('#startupname').val()=='' || $('#cin').val()=='' || $('#dpiit').val()=='' || $('#city').val()=='' || $('#country').val()=='' || $('#pin').val()=='' || $('#person').val()=='' || $('#persondesignation').val()=='' || $('#mobile').val()=='' || $('#email').val()=='')
		{
			$('#send').attr('disabled',true);
		} 
	});
	$('.myreq2').keyup(function(){
		if($('#teamsize').val()=='' || $('#name').val()=='' || $('#designation').val()=='' || $('#experience').val()=='')
		{
			$('#send2').attr('disabled',true);
		}
		else{
			$('#send2').attr('disabled',false);
			$("#send2").css("background-color", "#ee0979");
		}
	});
	$('.myreq3').keyup(function(){
		if($('#idea').val()=='' || $('#problem').val()=='' || $('#solution').val()=='' || $('#customer').val()=='' || $('#potential').val()=='' || $('#competitors').val()=='' || $('#diffrence').val()=='' || $('#usp').val()=='')
		{
		...
		else
		{
			$(function() {
				$('.areaCheck').click(function() {
					if ($('.areaCheck:checked').length > 0) {
						$('#send3').removeAttr('disabled');
						$("#send3").css("background-color", "#ee0979");
					} else {
						$('#send3').attr('disabled', 'disabled');
						$("#send3").css("background-color", "#C5C5F1");
					}
				});
			});
		}
	...
	$(function() {
		$('.myreq4').click(function() {
			if ($('.myreq44:checked').length > 0 && $('.myreq5:checked').length > 0) {
				$('#send4').removeAttr('disabled');
				$("#send4").css("background-color", "#ee0979");
			} else {
				$('#send4').attr('disabled', 'disabled');
				$("#send4").css("background-color", "#C5C5F1");
			}
		});  
	});   
});
 ...
 <script type="text/javascript">
    function ValidateEmail() {
        ...
        if (!expr.test(email)) {
			...
			$("#send").css("background-color", "#C5C5F1");
        }else  if (expr.test(email)){ 
			$('#send').removeAttr('disabled');
				$("#send").css("background-color", "#ee0979");
		}
    }
</script>
<script>
	function fileValidation(){ 
		var fileInput = document.getElementById("othersfounders");
		...
		if(!allowedExtensions.exec(filePath)){ 
			document.getElementById("fileerror").innerHTML="File is not valid. Only pdf file are allowed.";
			//alert("file not valid");
			fileInput.value = '';
			return false;
		}
		else{
			var fileb = document.getElementById("othersfounders").files[0].size;
			if(fileb > 2097152){
				document.getElementById("fileerror").innerHTML="File size is too big. File should be less then 2 MB.";
				//alert('size not allowed');
				fileInput.value = '';
				return false;
			}else if(fileb <= 2097152){ 
				document.getElementById("fileerror").innerHTML = '';
				document.getElementById("filecorrect").innerHTML="File selected.";
			}
		}
	}
	function fileValidation2(){ 
		var fileInput = document.getElementById("businessproposal");
		var filePath = fileInput.value;
		//alert(fileb);
		//die;
		var allowedExtensions = /(.pdf)$/i;
		...
		if(!allowedExtensions.exec(filePath)){ 
			document.getElementById("fileerror2").innerHTML="File is not valid. Only pdf file are allowed.";
			//alert("file not valid");
			fileInput.value = '';
			return false;
		}
		else{
			var fileb = document.getElementById("businessproposal").files[0].size;
			if(fileb > 5242880){
				document.getElementById("fileerror2").innerHTML="File size is too big. File should be less then 2 MB.";
				//alert('size not allowed');
				fileInput.value = '';
				return false;
			}else if(fileb <= 5242880){ 
				document.getElementById("fileerror2").innerHTML = '';
				document.getElementById("filecorrect2").innerHTML="File selected.";
			}
		}
	}
</script>