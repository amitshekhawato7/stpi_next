		...
		<div class="col-md-10">
			<form id="msform" action="" method="POST" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<hr>
					<input type="button" name="next" id="send" class="next action-button" value="Next" style="background-color:C5C5F1;"/>
				</fieldset>
				<fieldset>
					...
					<input type="button" name="next" id="send2" class="next action-button" value="Next" style="background-color:C5C5F1;"/>
				</fieldset>
				<fieldset>
...
<script>
	function fileValidation(){ 
		...
		if(!allowedExtensions.exec(filePath)){ 
			...
			//alert("file not valid");
				document.getElementById("filecorrect").innerHTML='';
			fileInput.value = '';
			return false;
		}
		else{
	...
	function fileValidation2(){ 
		...
		if(!allowedExtensions.exec(filePath)){ 
			...
			//alert("file not valid");
				document.getElementById("filecorrect2").innerHTML='';
			fileInput.value = '';
			return false;
		}
		else{
			...
			if(fileb > 5242880){
				document.getElementById("fileerror2").innerHTML="File size is too big. File should be less then 5 MB.";
				document.getElementById("filecorrect2").innerHTML='';
				//alert('size not allowed');
				fileInput.value = '';
				return false;
