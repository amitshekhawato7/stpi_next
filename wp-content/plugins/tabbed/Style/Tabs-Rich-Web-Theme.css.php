...
<style type="text/css">
	...
	.switch-light { padding: 0; background: #ffffff; background-image: none; }
	.switch-light .switch-label { background: #ffffff; border: solid 2px #ff0000; box-shadow: none; }
	...
	.switch-light .switch-input:checked ~ .switch-label { background: #ffffff; border-color: #79e271; }
