  ...
  class SPF_Shortcoder extends SPF_Abstract{
    ...
    public function __construct( $key, $params = array() ) {
      ...
      if( ! empty( $this->args['show_in_editor'] ) ) {
        ...
        SPF::$shortcode_instances[] = wp_parse_args( array( 'hash' => md5( $key ), 'modal_id' => $this->unique ), $this->args );
    ...
    ?>
      <div id="spf-modal-<?php echo $this->unique; ?>" class="spf-modal spf-shortcode<?php echo $single_usage; ?>" data-modal-id="<?php echo $this->unique; ?>" data-nonce="<?php echo wp_create_nonce( 'spf_shortcode_nonce' ); ?>">
        <div class="spf-modal-table">
          <div class="spf-modal-table-cell">
            ...
            <div class="spf-modal-inner">
              ...
              <div class="spf-modal-insert-wrapper wp-core-ui hidden"><a href="#" class="button button-primary spf-modal-insert"><?php echo $this->args['insert_title']; ?></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      if( ! empty( $shortcode_key ) && wp_verify_nonce( spf_get_var( 'nonce' ), 'spf_shortcode_nonce' ) ) {
        ...
        if( ! empty( $section ) ) {
          ...
          if( ! empty( $repeatable_fields ) ) {
            ...
            echo '<div class="spf--repeat-button-block wp-core-ui"><a class="button spf--repeat-button" href="#"><i class="fa fa-plus-circle"></i> '. $button_title .'</a></div>';
        ...
        echo '<div class="spf-field spf-text-error">'. esc_html__( 'Security check', 'spf' ) .'</div>';
      }
