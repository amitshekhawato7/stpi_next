...
if( ! class_exists( 'SPF_Widget' ) ) {
  class SPF_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      $this->key  = $key;
      $this->args = apply_filters( "spf_{$key}_args", $params, $this );
      ...
      // Set filters
      $widget_ops  = apply_filters( "spf_{$key}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "spf_{$key}_control_ops", $control_ops, $this );
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $new_instance = apply_filters( "spf_{$this->key}_save", $new_instance, $this->args, $this );

      do_action( "spf_{$this->key}_save_before", $new_instance, $this->args, $this );
