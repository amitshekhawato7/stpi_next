...
if( ! class_exists( 'SPF_Customize_Options' ) ) {
  class SPF_Customize_Options extends SPF_Abstract {
      ...
      if( ! empty( $this->sections ) ) {
        ...
        foreach( $sections as $section ) {
          ...
          if( ! empty( $section['subs'] ) ) {
            ...
            $wp_customize->add_panel( new WP_Customize_Panel_spf( $wp_customize, $panel_id, array(
              'title'       => $section['title'],
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      $wp_customize->add_section( new WP_Customize_Section_SPF( $wp_customize, $section_id, array(
      ...
      if( ! empty( $section_args['fields'] ) ) {
        ...
        foreach( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_spf( $wp_customize, $setting_id,
