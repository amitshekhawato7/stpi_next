		...
		<div class="col-md-10">
			<form id="msform" action="" method="POST" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<div class="">
						<input type="text" name="cin" id="cin" placeholder="CIN No." maxlength="20" class="myreq" onblur="return Validate()"/>
				...
				<fieldset>
					...
					<section align="left">
					<div>
						<textarea type="text" name="idea" id="idea" placeholder="Briefly describe your idea" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message15" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="problem" id="problem" placeholder="What problem are you solving?" onblur="return Validate5()" class="myreq3"></textarea>
						<label class="message" id="message16" style="color:#ff0000;font-weight:bold;">
					</div>
					<div> 
						<textarea type="text" name="solution" id="solution" placeholder="What is your solution?" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message17" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="customer" id="customer" placeholder="Who will be your customer?" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message18" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="ptential" id="potential" placeholder="What is your market potential?" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message19" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="competitors" id="competitors" placeholder="Do you have any competitors?" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message20" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="diffrence" id="diffrence" placeholder="How are you different from your competitor?" onblur="return Validate5()" class="myreq3"></textarea> 
						<label class="message" id="message21" style="color:#ff0000;font-weight:bold;">
					</div>
					<div>
						<textarea type="text" name="usp" id="usp" placeholder="What is your USP ( Unique Selling Proposition)?" onblur="return Validate5()" class="myreq3"></textarea> 
