    ...
    if (!empty($_POST["startupname"])) 
        {
            ...
            $query = "INSERT INTO stpinext_start_up_details (startup_name, startup_building, startup_street, startup_city, startup_state, startup_country, startup_pin, startup_cp_name, startup_designation,startup_mobile,startup_email) VALUES('$startupname', '$building', '$street', '$city', '$state', '$country', '$pin', '$person', '$designation', '$mobile','$email')"; 
            ...
            $promoters = "INSERT INTO stpinext_details_promotors(startup_id, promotors_size_team, promotors_name, promotors_designation, promotors_experience, promotors_file_name, promotors_file_path) VALUES('$last_id','$team','$name','$designation','$experience','$filename','$path_filename_ext')";
            $run2 = mysqli_query($conn, $promoters); 
            $idea = "INSERT INTO stpinext_your_idea(startup_id, idea_describe_your_idea, idea_prblm_solving, idea_your_solution, idea_your_customer, idea_market_potential, idea_compositors, idea_different_from_competitors, idea_usp, idea_business_proposal_file_name, idea_business_proposal_file_path) VALUES('$last_id', '$idea', '$problemsolving', '$solution', '$customer', '$marketpotential', '$competitors', '$differentfromcompetitors', '$usp', '$filename2', '$path_filename_ext2')";
            $run3 = mysqli_query($conn, $idea);
            $requirestpinext = "INSERT INTO stpinext_require_from_stpinext(startup_id, require_stations, require_funding, require_services, require_uses) VALUES('$last_id', '$stations', '$funding', '$platforms', '$facilities')";
    ...
    <div class="form-group">
        <input type="hidden" name="_charset_" />
            <section><h2>Details of the Promoters/Founders</h2>
                <div class="form-field form-text form-text required">
                    <label for="team">Size of the Founding Team<abbr class="required" title="required">*</abbr></label>
                    <div class="input-wrapper with-icon">
                        <input type="text" 
                            id="team" 
                            name="team"  
